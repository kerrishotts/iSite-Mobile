...
<div class="navSubItemGroup" id="grpMainMenu" >
    ...
    <a id="mnuMainNews"       title="News"       href="javascript:loadContent('./news.php', updateMainMenu );"       class="navSubItem"><img src="./images/tabsfreecolor/RSS-Alternative.png"> News</a>
    <a id="mnuMainExamples"   title="Examples"   href="javascript:loadContent('./examples.php', updateMainMenu );"   class="navSubItem"><img src="./images/tabsfreecolor/Heart.png"> Examples</a>
    ...
    <a id="mnuMainFacebook"   title="Google+"   href="javascript:loadContent('./gplus.php', updateMainMenu );"   class="navSubItem"><img src="./images/tabsfreecolor/Facebook.png"> Google+</a>
